...
public class EngineController {
    ...
    public String getAllEngines(Model model) {
        List<EngineDTO> engineDTOS = engineService.findAll();
        model.addAttribute("engineDTOS", engineDTOS);
        return TEMPLATE_LOCATION.concat("engine-view-plain");
    }
    ...
    public String addEngine(Model model) {
        ...
        return TEMPLATE_LOCATION.concat("engine-view-form-plain");
    }
    ...
    @PostMapping("/form")
    public String addEngine(@ModelAttribute(name = "engineForm") @Valid EngineDTO engineDTO, BindingResult result) {
        if(result.hasErrors()){
            return TEMPLATE_LOCATION.concat("engine-view-form-plain");
        }
    ...
    public String deleteEngine(@PathVariable Integer id) {
        EngineDTO deletedEngine = engineService.delete(id);
        return "redirect:/engine";
    }
}